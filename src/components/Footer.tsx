...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-border py-32 px-6 mt-40">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-20 pb-20">
          {/* Brand Column */}
          <div className="space-y-10">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-muted-foreground hover:text-black transition-colors"><Cpu size={20} /></a>
              <a href="#" className="text-muted-foreground hover:text-black transition-colors"><Globe size={20} /></a>
              <a href="#" className="text-muted-foreground hover:text-black transition-colors"><Mail size={20} /></a>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-4 text-xs font-bold text-muted-foreground">
              <Link href="/" className="hover:text-black transition-colors">Archive</Link>
              <Link href="/intro" className="hover:text-black transition-colors">Manifesto</Link>
