    ...
    <div className="min-h-screen bg-background transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-8">
           ...
           <div className="p-6 rounded-[2rem] bg-card border border-border shadow-sm max-w-sm">
              <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-2">Network Status</p>
              <p className="text-xs font-medium text-foreground leading-relaxed">
                Analyzing the focus across all <strong>{mapData.length}</strong> active topics in the community network.
              </p>
           </div>
        </div>
        ...
        {mapData.length > 0 ? (
          ...
          <div className="py-40 text-center border-2 border-dashed border-border rounded-[4rem] bg-card">
             <div className="max-w-md mx-auto space-y-4">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground">Data pending...</p>
                <p className="text-sm font-bold text-muted-foreground uppercase leading-relaxed">The network is currently gathering community data. Check back shortly.</p>
             </div>
          </div>
        )}
